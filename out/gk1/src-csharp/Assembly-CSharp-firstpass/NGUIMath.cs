...
public static class NGUIMath
{
	...
	private static void CalculateRelativeWidgetBounds(Transform content, bool considerInactive, bool isRoot, ref Matrix4x4 toLocal, ref Vector3 vMin, ref Vector3 vMax, ref bool isSet, bool considerChildren)
	{
		...
		if (component != null && component.enabled)
		{
			...
			if (!considerChildren && component.GetComponent<ConsiderChildren>() == null)
			{
				return;
			}
		}
		...
		{
			CalculateRelativeWidgetBounds(content.GetChild(k), considerInactive, isRoot: false, ref toLocal, ref vMin, ref vMax, ref isSet, considerChildren);
		}
	}
