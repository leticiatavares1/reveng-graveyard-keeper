...
public class RVOController : MonoBehaviour
{
	...
	public void Awake()
	{
		...
		{
			cachedSimulator = Object.FindObjectOfType<RVOSimulator>();
		}
		if (cachedSimulator == null)
		{
	...
	public void Update()
	{
		...
		if ((int)mask != 0 && Physics.Raycast(interpolatedPosition + Vector3.up * height * 0.5f, Vector3.down, out var hitInfo, float.PositiveInfinity, mask))
		{
