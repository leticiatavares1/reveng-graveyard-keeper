...
public class GraphUpdateScene : GraphModifier
{
	...
	public void ToggleUseWorldSpace()
	{
		...
		{
			convexPoints = null;
			Matrix4x4 matrix4x = (useWorldSpace ? base.transform.localToWorldMatrix : base.transform.worldToLocalMatrix);
	...
	public void OnDrawGizmos(bool selected)
	{
		...
		Gizmos.color = color;
		Matrix4x4 matrix4x = (useWorldSpace ? Matrix4x4.identity : base.transform.localToWorldMatrix);
		if (convex)
		{
			color.r -= 0.1f;
			color.g -= 0.2f;
