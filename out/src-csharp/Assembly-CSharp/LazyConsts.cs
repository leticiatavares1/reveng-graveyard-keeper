...
public static class LazyConsts
{
	...
	public const int GRID_SIZE = 96;

	public const int GRID_SIZE_HALF = 48;

	public static readonly Vector2 GRID_SIZE_VECTOR2 = new Vector2(96f, 96f);

	public static readonly Vector2 GRID_SIZE_VECTOR2_08 = new Vector2(76.8f, 76.8f);

	private const float INTERACTIVE_DROPS_RADUIS = 1.8f;
	...
	public const int CHAR_MASK = 512;

	public const int CAMERA_BOUNDS_MASK = 131072;

	public const int DROPS_MASK = 16384;

	public const int OBJ_MASK = 66305;

	public const int ZONES_MASK = 524288;

	public const int BUILD_COLLIDERS_MASK = 8388608;

	public const int PROJECTILE_MASK = 66049;

	public const int BUILD_IGNORE_LAYER_MASK = 268435456;

	public const int NGUI_MASK = 8192;

	public const float INTERACTIVE_DROPS_RADUIS_SQR = 3.2399998f;

	public static bool editor_updates_allowed = true;

	public static readonly bool DYAK = true;

	public static float PI2 = (float)Math.PI * 2f;

	public static float PI_DIV_2 = (float)Math.PI / 2f;
	...
	public const GameSaveSerializer GAME_SERIALIZER = GameSaveSerializer.Binary;
