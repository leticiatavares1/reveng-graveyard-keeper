...
public class UserDataStore_PlayerPrefs : UserDataStore
{
	...
	{
		PlayerPrefs.SetString(GetControllerMapPlayerPrefsKey(player, saveData.controller, saveData.categoryId, saveData.layoutId, includeDuplicateIndex: true), saveData.map.ToXmlString());
		PlayerPrefs.SetString(GetControllerMapKnownActionIdsPlayerPrefsKey(player, saveData.controller, saveData.categoryId, saveData.layoutId, includeDuplicateIndex: true), GetAllActionIdsString());
	}
