...
public class ReflectedFunction<TResult> : ReflectedFunctionWrapper
{
	...
	{
		TResult val2 = (result.value = call());
		return val2;
	}
}
[Serializable]
public class ReflectedFunction<TResult, T1> : ReflectedFunctionWrapper
{
	...
	public override object Call()
	{
		TResult val2 = (result.value = call(p1.value));
		return val2;
	}
}
[Serializable]
public class ReflectedFunction<TResult, T1, T2> : ReflectedFunctionWrapper
{
	...
	public override object Call()
	{
		TResult val2 = (result.value = call(p1.value, p2.value));
		return val2;
	}
}
[Serializable]
public class ReflectedFunction<TResult, T1, T2, T3> : ReflectedFunctionWrapper
{
	...
	public override object Call()
	{
		TResult val2 = (result.value = call(p1.value, p2.value, p3.value));
		return val2;
	}
}
[Serializable]
public class ReflectedFunction<TResult, T1, T2, T3, T4> : ReflectedFunctionWrapper
{
	...
	public override object Call()
	{
		TResult val2 = (result.value = call(p1.value, p2.value, p3.value, p4.value));
		return val2;
	}
}
[Serializable]
public class ReflectedFunction<TResult, T1, T2, T3, T4, T5> : ReflectedFunctionWrapper
{
	...
	public override object Call()
	{
		TResult val2 = (result.value = call(p1.value, p2.value, p3.value, p4.value, p5.value));
		return val2;
	}
}
[Serializable]
public class ReflectedFunction<TResult, T1, T2, T3, T4, T5, T6> : ReflectedFunctionWrapper
{
	...
	public override object Call()
	{
		TResult val2 = (result.value = call(p1.value, p2.value, p3.value, p4.value, p5.value, p6.value));
		return val2;
	}
}
