...
public class ProCamera2DTransitionsFX : BasePC2D
{
	...
	{
		Transition(_transitionEnterMaterial, time ?? DurationEnter, DelayEnter, 1f, 0f, EaseTypeEnter);
	}

	public void TransitionExit(float? time = null)
	{
		Transition(_transitionExitMaterial, time ?? DurationExit, DelayExit, 0f, 1f, EaseTypeExit);
	}
