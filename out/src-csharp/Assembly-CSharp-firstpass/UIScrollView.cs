...
public class UIScrollView : MonoBehaviour
{
	...
	public bool isScrolling
	{
		get
		{
			...
			{
				return Mathf.Abs(mScroll) > 0.0001f;
			}
			return true;
		}
	}
	...
	public virtual Bounds bounds
	{
		get
		{
			if (!mCalculatedBounds)
			{
				...
				{
					mBounds = NGUIMath.CalculateRelativeWidgetBounds(mTrans, mTrans, !mTrans.gameObject.activeSelf, considerChildren: false);
				}
			}
			return mBounds;
		}
	...
	public virtual bool shouldMoveHorizontally
	{
		get
		{
			...
			return Mathf.RoundToInt(num - panel.width) > 0;
		}
	}
	...
	public virtual bool shouldMoveVertically
	{
		get
		{
			...
			return Mathf.RoundToInt(num - panel.height) > 0;
		}
	}
	...
	public bool NeedsRestriction(bool horizontal = true, bool vertical = true)
	{
		if (mPanel == null)
		{
			return false;
	...
	{
		if (base.enabled && NGUITools.GetActive(base.gameObject) && scrollWheelFactor != 0f && shouldMove)
		{
			DisableSpring();
			mShouldMove |= shouldMove;
