...
public class Flow_SendSawmillWorkerToPutTarget : GKCustomFlowNode
{
	...
	private void DoAction(Flow flow)
	{
		...
		if (selfWgoData.Worker is ZombieWgoData zombieWgoData)
		{
			...
			zombieWgoData.MovementComponent.StartPath(gDPointData.Position, zombieWgoData.WorldZoneData.navigationGraph, zombieWgoData.WorldId, 1.5f, "sawmill_on_went_to_container");
		}
		else
		{
