...
public class PikeHitBox : MonoBehaviour, IDamageDealer
{
	...
	private void OnTriggerEnter(Collider other)
	{
		...
		if (componentInParent == null || componentInParent.TeamType == attackContext.teamType)
		{
			return;
		}
		...
		else if (hitResult.type != HitResultType.Absorbed && (!value.DamageDealt || !hitResult.ShouldDealDamage))
		{
